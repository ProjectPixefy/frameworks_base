...
import com.android.internal.util.pixefy.PixefyUtils;
...
public abstract class UdfpsDrawable extends Drawable {
    ...
    String udfpsResourcesPackage = "org.pixefy.udfps.icons";
    ...
    void init() {
        if (PixefyUtils.isPackageInstalled(mContext, udfpsResourcesPackage)) {
            try {
